...
const isRailway = process.env.RAILWAY === '1' || process.env.RAILWAY_SERVICE_NAME;
...
if (isVercel) {
  ...
  DATA_DIR = '/app/data';  // Railway 使用 /app
} else {
...
const server = app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`Environment: ${isRailway ? 'Railway' : isVercel ? 'Vercel' : 'Local'}`);
});
